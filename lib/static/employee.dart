...
void main() {
  Employee employee1 = Employee("홍길동1"); // 1;
  Employee employee2 = Employee("홍길동2"); // 2;
  Employee employee3 = Employee("홍길동3"); // 3;
  // 제약 조건
  // Employee 클래스 안에 사원 번호 데이터를 받는 변수를 선언 하시오
  // 단, Employee가 인스턴스화 되면(객체) 사원 번호는 자동으로 1씩 증가할 수 있도록 만들어 주세요
